 ...
 */
extern "C" esp_err_t esp_code_scanner_set_config(esp_image_scanner_t* scanner, const esp_code_scanner_config_t config);
 ...
 */
extern "C" int esp_code_scanner_scan_image(esp_image_scanner_t* scanner, const uint8_t *image_data);
 ...
 *
 */
extern "C" void esp_code_scanner_destroy(esp_image_scanner_t* scanner);
 ...
 */
extern "C" const esp_code_scanner_symbol_t esp_code_scanner_result(esp_image_scanner_t* scanner);